...
Check out the [quick start](./examples/quick-start.md) in the examples section of the docs for a project that demonstrates Banjo in under 125 lines of code
